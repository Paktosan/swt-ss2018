...
import de.paktosan.university.swt.exam.parts.*;
...
public class StockTest {
    ...
    @Test
    public void testRegisterNullArgument() {
        try {
            stock.register(null);
            fail("Stock.register() should throw a NullPointerException if the argument is null");
        } catch (NullPointerException e) {
        }
    }
}
