package de.paktosan.university.swt.tests;

import java.lang.reflect.Method;
import java.lang.reflect.Modifier;

import de.paktosan.university.swt.leetspeek.Leet;
...
public class LeetTest {
    ...
    public void testAllToLeet() {
        ...
        assertNotSame("Leet.allToLeet(String[]): This method should not write into the parameter array but instead create a new one.", actualText, orgText);
        assertEquals("Leet.allToLeet(String[]): Returned array must have the same length as the array passed to the method.", orgText.length, actualText.length);
