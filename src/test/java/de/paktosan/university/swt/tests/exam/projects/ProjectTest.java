...
import de.paktosan.university.swt.exam.projects.Deliverable;
import de.paktosan.university.swt.exam.projects.Project;
import de.paktosan.university.swt.exam.projects.Task;
...
public class ProjectTest {
    ...
    private Task t1;
    private Map<Calendar, List<Deliverable>> expDeliv_Task1;
    private Map<Calendar, List<Deliverable>> expDeliv_Task2;
    ...
    public void setUp() {
        ...
        expDeliv_Task1 = new HashMap<Calendar, List<Deliverable>>();
        expDeliv_Task2 = new HashMap<Calendar, List<Deliverable>>();

        cal = new GregorianCalendar(2008, 2, 10);
        ...
        cal = new GregorianCalendar(2008, 3, 2);
        ...
        cal = new GregorianCalendar(2008, 3, 23);
    ...
    public void testSetTask() {
        ...
        assertTrue("Project.setTask() should set the main task correctly!",
                expDeliv_Task1.equals(project.allDeliverables()));
    }
    ...
    public void testAllDeliverables() {
         ...
         * lists.
         */
        Comparator<Deliverable> comp = new Comparator<Deliverable>() {
            @Override
            public int compare(Deliverable o1, Deliverable o2) {
                return o1.hashCode() < o2.hashCode() ? -1 : o1.hashCode() == o2.hashCode() ? 0 : 1;
            }
        };
        Map<Calendar, List<Deliverable>> actDeliv = project.allDeliverables();
