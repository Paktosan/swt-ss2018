...
import de.paktosan.university.swt.exam.projects.Adapter;
...
public class AdapterTest {
    ...
    public void setUp() {
        ...
        d1 = new Deliverable("checkTask", "Request task-list", 1.0, 10, 30.0, new GregorianCalendar(2008, 2, 10));
        d2 = new Deliverable("checkAvailability", "Check availability of goods", 1.0, 0, 100.0, new GregorianCalendar(
                2008, 2, 20));
        d3 = new Deliverable("checkAccount", "Check customers account", 1.0, 30, 30.0, new GregorianCalendar(2008, 3,
                2));
        d4 = new Deliverable("confirmOrder", "Deliver goods", 2.0, 1000, 100.0, new GregorianCalendar(2008, 3, 23));
